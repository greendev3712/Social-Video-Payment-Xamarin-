...
namespace WoWonder.Activities.Upgrade.Adapters
{
    ...
    public class UpgradeGoProAdapter : RecyclerView.Adapter
    {
                        ...
                        foreach (var type in ListUtils.SettingsSiteList?.ProPackagesTypes)//"1": "star"
                        {
                            ...
                            switch (resourceId)
                            {
                                ...
                                default:
                                {
                                            if (type.Key == "1")
                                            {
                                                var proClass1 = new UpgradeGoProClass
                                                {
                                                    Id = "0",
                                                    HexColor = GetColor("#337ab7"),
                                                    PlanText = "Free",
                                                    PlanPrice = "0.00",
                                                    PlanTime = GetTime(""),
                                                    PlanArray = GetPlanArray2("0"),
                                                    ImageResource = ActivityContext.Resources?.GetIdentifier("ic_plan_0", "drawable", ActivityContext.PackageName) ?? 0,
                                                };

                                                PlansList.Add(proClass1);
                                            }
                                    var proClass = new UpgradeGoProClass
                                    {
                                        ...
                                        PlanArray = GetPlanArray2(type.Key),
        ...
        private Dictionary<string, string> GetPlanArray2(string key)
        {
            try
            {
                /* 
                ...
                */
                ...
                {
                    case "0":
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_8), IonIconsFonts.Checkmark);
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_9), IonIconsFonts.Checkmark);
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_10), IonIconsFonts.Checkmark);
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_11), IonIconsFonts.Checkmark);
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_12), IonIconsFonts.Checkmark);
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_13), IonIconsFonts.Checkmark);
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_1), IonIconsFonts.Close);
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_2), IonIconsFonts.Close);
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_3), IonIconsFonts.Close);
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_4), IonIconsFonts.Close);
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_5), IonIconsFonts.Close);
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_6), IonIconsFonts.Close);
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_7), IonIconsFonts.Close);
                        break;
                    case "1":
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_8), IonIconsFonts.Checkmark);
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_9), IonIconsFonts.Checkmark);
                        ...
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_12), IonIconsFonts.Checkmark);
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_13), IonIconsFonts.Checkmark);
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_1), IonIconsFonts.Checkmark);
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_2), IonIconsFonts.Close);
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_3), IonIconsFonts.Checkmark);
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_4), IonIconsFonts.Checkmark);
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_5), IonIconsFonts.Close);
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_6), "1 Boost");
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_7), "1 Boost");
                        break;
                    case "2":
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_8), IonIconsFonts.Checkmark);
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_9), IonIconsFonts.Checkmark);
                        ...
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_13), IonIconsFonts.Checkmark);
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_1), IonIconsFonts.Checkmark);
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_2), IonIconsFonts.Checkmark);
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_3), IonIconsFonts.Checkmark);
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_4), IonIconsFonts.Checkmark);
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_5), IonIconsFonts.Checkmark);
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_6), "5 Boost");
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_7), "5 Boost");
                        break;
                    case "3":
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_8), IonIconsFonts.Checkmark);
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_9), IonIconsFonts.Checkmark);
                        ...
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_4), IonIconsFonts.Checkmark);
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_5), IonIconsFonts.Checkmark);
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_6), "20 Boost");
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_7), "20 Boost");
                        break;
                    case "4":
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_8), IonIconsFonts.Checkmark);
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_9), IonIconsFonts.Checkmark);
                        ...
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_4), IonIconsFonts.Checkmark);
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_5), IonIconsFonts.Checkmark);
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_6), "30 Boost");
                        dictionary.Add(ActivityContext.GetText(Resource.String.Lbl_go_pro_item_7), "30 Boost");
                        break;
                }
                return dictionary;
            }
                ...
                switch (viewHolder)
                {
                    case UpgradePlansViewHolder holder:
                    {
                        ...
                        if (item != null)
                        {
                            ...
                            if (item.PlanText == "star")
                            {
                                holder.PlanText.Text = "VERIFIED";
                            } 
                            else if (item.PlanText == "hot")
                            {
                                holder.PlanText.Text = "FEATURED";
                            }
                            else if (item.PlanText == "ultima")
                            {
                                holder.PlanText.Text = "PATRIOT";
                            } else if (item.PlanText == "Free")
                                {
                                    holder.PlanText.Text = "FREE";
                                }
                            else
                            {
                                holder.PlanText.Text = "POLITICIAN";
                            }
                            ...
                            holder.PriceText.SetTextColor(Color.ParseColor(item.HexColor));
                                if (item.Id == "0")
                                {
                                    holder.UpgradeButton.Text = "Continue";
                                }
                            ...
                            switch (item.PlanArray?.Count)
                            {
                                case > 0:
                                {
                                    ...
                                    {
                                        //var content =  options.Key + ": " + options.Value;
