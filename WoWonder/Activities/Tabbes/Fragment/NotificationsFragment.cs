    ...
    public class NotificationsFragment : AndroidX.Fragment.App.Fragment
    {
        ...
        public override void OnViewCreated(View view, Bundle savedInstanceState)
        {
            try
            {
                ...
                Task.Factory.StartNew(() => StartSearchRequest());
        ...
        private void SwipeRefreshLayoutOnRefresh(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!Methods.CheckConnectivity())
                    ...
                    PollyController.RunRetryPolicyFunction(new List<Func<Task>> { () => LoadGeneralData(true), StartSearchRequest });
            }
            catch (Exception exception)
            {
                Methods.DisplayReportResultTrack(exception);
            ...
            try
            {
                ...
                if (item != null && !string.IsNullOrEmpty(item.NotifierId) && !MainScrollEvent.IsLoading)
                {
                    if (!Methods.CheckConnectivity())
                        ...
                        PollyController.RunRetryPolicyFunction(new List<Func<Task>> { () => LoadGeneralData(false, item.NotifierId), StartSearchRequest });
                }
            }
            catch (Exception exception)
            {
                                        ...
                                        case > 0 when AppSettings.ShowProUsersMembers:
                                            {
                                                ...
                                                switch (checkList)
                                                {
                                                    case null:
                                                        {
                                                            ...
                                                            foreach (var item in from item in result.Users let check = proUser.UserList.FirstOrDefault(a => a.UserId == item.UserId) where check == null select item)
                                                            {
                                                    ...
                                                    default:
                                                        {
                                                            foreach (var item in from item in result.Users let check = checkList.UserList.FirstOrDefault(a => a.UserId == item.UserId) where check == null select item)
                                                            {
                                ...
                                case GetGeneralDataObject result:
                                    Activity?.RunOnUiThread(() =>
                                    {
                                        try
                                        {
                                                    ...
                                                    switch (respondListHashTag)
                                                    {
                                                        case > 0 when AppSettings.ShowTrendingHashTags:
                                                        {
                                                            ...
                                                            switch (checkList)
                                                            {
                                                                case null:
                                                                {
                                                                    GlobalContext.TrendingTab.MAdapter.TrendingList.Insert(2, new Classes.TrendingClass
                                                                    {
                                                                        Id = 900,
                                                                    ...
                                                                    {
                                                                        GlobalContext.TrendingTab.MAdapter.TrendingList.Insert(index, new Classes.TrendingClass
                                                                        {
                                            ...
                                            {
                                                Console.WriteLine("============ " + result.Announcement?.AnnouncementClass?.TextDecode + " ===========");
