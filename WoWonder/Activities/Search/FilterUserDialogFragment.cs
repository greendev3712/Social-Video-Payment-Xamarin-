...
{
    public class FilterUserDialogFragment : BottomSheetDialogFragment, MaterialDialog.IListCallback, MaterialDialog.ISingleButtonCallback, IDialogInterfaceOnShowListener
    {
        #region Variables Basic

        private BrowserUserActivity ContextSearch;
        ...
        public override void OnCreate(Bundle savedInstanceState)
        {
            ...
            ContextSearch = (BrowserUserActivity)Activity;
        }
