...
namespace WoWonder.Activities.Fundings
{
    ...
    public class FundingActivity : BaseActivity, TabLayoutMediator.ITabConfigurationStrategy, MaterialDialog.IListCallback, MaterialDialog.ISingleButtonCallback
    {
        ...
        public HowitworksFragment HowitworksTab;
        public FaqFragment FaqTab;
        ...
        private void InitComponent()
        {
            try
            {
                ...
                BtnCreate = FindViewById<AppCompatButton>(Resource.Id.btn_create_fund);
            }
            catch (Exception e)
            {
                Methods.DisplayReportResultTrack(e);
        ...
        private void SetUpViewPager(ViewPager2 viewPager)
        {
            try
            {
                ...
                HowitworksTab = new HowitworksFragment();
                FaqTab = new FaqFragment();
                ...
                Adapter.AddFragment(HowitworksTab, GetText(Resource.String.Lbl_HowItWorks));
                Adapter.AddFragment(FaqTab, GetText(Resource.String.Lbl_Faq));

                int tabIdx = 0;
                int index = Intent?.GetIntExtra("fundraiser", tabIdx) ?? tabIdx;
