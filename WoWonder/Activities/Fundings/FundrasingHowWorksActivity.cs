...
namespace WoWonder.Activities.Fundings
{
    ...
    public class FundrasingHowWorksActivity : BaseActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            try
            {
                ...
                SetContentView(Resource.Layout.FundraiserHowWorks);
        ...
        private void InitComponent()
        {
            try
            {
                //BtnCreateFunding = FindViewById<AppCompatButton>(Resource.Id.btn_create_fraiser);
            }
            catch (Exception e)
            {
                Methods.DisplayReportResultTrack(e);
        ...
        private void InitToolbar()
        {
            try
            {
                ...
                if (toolBar != null)
                {
                    toolBar.Title = GetString(Resource.String.Lbl_HowItWorks);
