...
namespace WoWonder.Activities.Album.Adapters
{
    public class AlbumsAdapter : RecyclerView.Adapter, ListPreloader.IPreloadModelProvider
    {
        ...
        public event EventHandler<AlbumsAdapterClickEventArgs> CloseItemClick;
        ...
        public override RecyclerView.ViewHolder OnCreateViewHolder(ViewGroup parent, int viewType)
        {
            try
            {
                ...
                var vh = new AlbumsAdapterViewHolder(itemView, Click, LongClick, CloseClick);
                return vh;
            }
            catch (Exception e)
            {
        ...
        private void CloseClick(AlbumsAdapterClickEventArgs args)
        {
    ...
    public class AlbumsAdapterViewHolder : RecyclerView.ViewHolder
    {
        ...
        public AlbumsAdapterViewHolder(View itemView, Action<AlbumsAdapterClickEventArgs> clickListener, Action<AlbumsAdapterClickEventArgs> longClickListener, Action<AlbumsAdapterClickEventArgs> closeClickListener) : base(itemView)
        {
            try
            {
                MainView = itemView;
                ...
                CloseImage = MainView.FindViewById<CircleButton>(Resource.Id.iv_close_album);
                ...
                CloseImage.Click += (sender, e) => closeClickListener(new AlbumsAdapterClickEventArgs { View = itemView, Position = BindingAdapterPosition });
            }
            catch (Exception e)
            {
                Methods.DisplayReportResultTrack(e);
