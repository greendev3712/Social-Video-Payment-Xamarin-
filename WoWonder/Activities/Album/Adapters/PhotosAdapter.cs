...
namespace WoWonder.Activities.Album.Adapters
{
    public class PhotosAdapter : RecyclerView.Adapter, ListPreloader.IPreloadModelProvider
    {
        ...
        public event EventHandler<PhotosAdapterClickEventArgs> ItemCloseClick;
        ...
        public override RecyclerView.ViewHolder OnCreateViewHolder(ViewGroup parent, int viewType)
        {
            try
            {
                ...
                var vh = new PhotosAdapterViewHolder(itemView, Click, LongClick, CloseClick);
                return vh;
            }
        ...
        private void CloseClick(PhotosAdapterClickEventArgs args)
        {
            ItemCloseClick?.Invoke(this, args);
        }
    ...
    {
        public PhotosAdapterViewHolder(View itemView, Action<PhotosAdapterClickEventArgs> clickListener,Action<PhotosAdapterClickEventArgs> longClickListener, Action<PhotosAdapterClickEventArgs> closeClickListener) : base(itemView)
        {
            try
            {
                MainView = itemView;
                ...
                CloseImage.Click += (sender, e) => closeClickListener(new PhotosAdapterClickEventArgs { View = itemView, Position = BindingAdapterPosition });
            }
            catch (Exception exception)
            {
                Methods.DisplayReportResultTrack(exception);
