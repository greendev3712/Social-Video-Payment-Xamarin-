    ...
    public class PopupDialogController
    {
        ...
        public class DatePickerFragment : AndroidX.Fragment.App.DialogFragment, DatePickerDialog.IOnDateSetListener
        {
            ...
            public override Dialog OnCreateDialog(Bundle savedInstanceState)
            {
                ...
                DatePickerDialog dialog = new DatePickerDialog(Activity,AppSettings.SetTabDarkTheme ? Resource.Style.MyTimePickerDialogTheme_Dark : Resource.Style.MyTimePickerDialogTheme, this, currently.Year, currently.Month - 1, currently.Day);
                return dialog;
            }
